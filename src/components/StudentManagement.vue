                ...
                <el-col :span="7">
                    ...
                    <el-form-item label="班期" prop="gradeid" :label-width="formLabelWidth">
                        <el-select v-model="studentForm.gradeid" placeholder="请选择班期" style="width: 300px">
                            <el-option v-for="item in noEndgradeData" :key="item" :value="item" :label="item"></el-option>
                        </el-select>
                    </el-form-item>
                </el-col>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getNoEndGrade: function () {
              axios.get("/getNoEndGrade").then(res => {
                this.noEndgradeData = res.data.data;
              })
            },
